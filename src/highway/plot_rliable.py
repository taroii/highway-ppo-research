"""
Aggregate, reviewer-facing comparison via the ``rliable`` package
(Agarwal et al. 2021): interquartile mean with stratified-bootstrap 95%
confidence intervals, a performance profile, and probability of
improvement -- aggregated across tasks at a matched action budget.
